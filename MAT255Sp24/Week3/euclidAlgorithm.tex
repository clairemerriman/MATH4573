...
\begin{theorem}[Euclidean algorithm]\label{euclid-alg}
...
=======
	 \Cref{lem:gcd-remainders} states that for $a=bq_1+r_1$, $\gcd(a,b)=\gcd(b,r_1)$. This is because any common divisor of $a$ and $b$  is also a divisor of $r_1=a-bq_1$. 
