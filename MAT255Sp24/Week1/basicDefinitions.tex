...
\begin{definition}[Even and odd, multiplication definition]\label{defn:even-odd-form}
...
\begin{definition}[Even and odd, division definition]\label{defn:even-odd-divides}
...
\begin{problem}\label{br:sqr-evens}
  Prove this theorem.
